...
var hostname = process.env.NODE_ENV !== 'production' ? 'localhost' : "directoriomedicodecolombia.co";
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!(pathname === '/a')) return [3 /*break*/, 2];
                    return [4 /*yield*/, app.render(req, res, '/a', query)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 6];
                case 2:
                    if (!(pathname === '/b')) return [3 /*break*/, 4];
                    return [4 /*yield*/, app.render(req, res, '/b', query)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 6];
